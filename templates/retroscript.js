...
if (obj) {
    ...
    document.getElementById("contactdetail").innerHTML = obj["email"] + ` | ` + obj["contact"] + ` | ` + obj["address"];
    if (obj["email"] == "" && obj["contact"] == "" && obj["address"] == "" ) {
...
if (storedEducationData) {
    ...
    storedEducationData.forEach((education) => {
        ...
        const newdata = `<p><strong>` + education.degree + `</strong></p>` +
